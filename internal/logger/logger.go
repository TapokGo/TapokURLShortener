...
type Logger interface {
	...
	// Info logs a message at Warn level.
	// Args must be provided as key-value pairs
	Warn(msg string, args ...any)

	// Info logs a message at Error level.
	// Args must be provided as key-value pairs
	Error(msg string, args ...any)

	// Info logs a message at Debug level.
	// Args must be provided as key-value pairs
	Debug(msg string, args ...any)

	// Return logger with new context(static key-value pair).
